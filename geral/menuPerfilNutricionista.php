...
<div class="w3-top"   >  
	<div class="w3-row w3-white w3-padding" >
		...
		<div class="w3-bar w3-cyan w3-large" style="z-index:-1">
			...
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="cadNutricionista.php">Dados Pessoais</a>
